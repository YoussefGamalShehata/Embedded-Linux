...
public:
    ...
    My_Vector(int Cap, int value) : Capacity(Cap), CurrentSize(Cap)
    {
        if (Cap == 0)
        {
    ...
    void Vector_pushback(int value)
    {
    ...
    void Vector_insertAt(int index, int value)
    {
    ...
    void Vector_insertMiddle(int value)
    {
